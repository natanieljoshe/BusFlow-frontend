<header class="min-h-[4rem] py-2 bg-[#0f172a]/80 backdrop-blur-md border-b border-slate-800 flex items-center justify-between px-4 sm:px-6 z-10 sticky top-0">
    <div class="flex items-center gap-3 sm:gap-4 flex-1">
        <button id="mobile-menu-btn" class="md:hidden text-slate-400 hover:text-indigo-400 transition-colors focus:outline-none shrink-0">
            <i class="fa-solid fa-bars text-xl"></i>
        </button>
        <div class="flex flex-col justify-center">
            <h1 class="text-sm sm:text-lg font-semibold text-slate-100 tracking-wide leading-snug break-words">@yield('header_title', 'Global Intelligence Hub')</h1>
